# Hi, I'm Jimmy Bonant 👋
I am a performance-driven **MLOps & Platform Engineer** specializing in bridging the gap between heavy Machine Learning models and highly scalable, production-grade cloud and edge infrastructure. I focus on automation, eliminating compute bottlenecks, and building deterministic infrastructure.
### 🚀 Technical Core* **Orchestration & Compute:** Kubernetes (K8s, K3s), Docker* **Infrastructure as Code (IaC):** Terraform, CloudFormation* **GitOps & CI/CD:** ArgoCD, Jenkins Pipelines, GitHub Actions* **AI/ML Platforms:** vLLM Optimization, LangChain Architecture, Vector Databases (RAG)* **Languages:** Python, Go, Bash
### 🛠️ Featured Architecture Projects
#### 🔹 [vllm-rag-bot](https://github.com)
An optimized RAG pipeline engineered for low-latency inference serving. * Leveraged **vLLM** to parallelize token generation and prevent GPU memory starvation during concurrent requests.* Integrated **LangChain** for robust context injection and semantic data parsing.

#### 🔹 [local-k3s-infra](https://github.com)
